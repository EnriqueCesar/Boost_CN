const CACHE="boost-cn-v4-20260711";
const CORE=["./","./index.html","./css/styles.css","./js/app.js","./manifest.json","./assets/boost-cn.png","./data/manifest-data.json","./data/audit-summary.json","./data/base-at.json","./data/condition.json","./data/exceptions.json"];
